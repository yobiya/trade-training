...
| `analyzingSymbol, symbolMode, entryTf, activeTf, hiddenTfs, memoOpen, skipping, confirmSkipAll, skipAllReasonDraft, hoveredEvent` | SessionPage local | UI 配置に直結する分のみ。`symbolMode: 'all' \| 'star'` はヘッダ銘柄セレクタの絞り込みモード |
