"""drop session-related tables and trading_styles (move to file management)
...
def downgrade() -> None:
    ...
    raise NotImplementedError(
        "本テーブル drop は不可逆。データはファイル管理側(data/sessions/, data/trading-styles/)"
        "にあるため、SQLite 側の復元は不要。"
    )
